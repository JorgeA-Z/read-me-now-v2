package com.readme.now.readmenow.structure.book.infrastructure.adapter.out.entity;

import com.readme.now.readmenow.structure.author.infrastructure.adapter.out.entity.Author;
import com.readme.now.readmenow.structure.reading.infrastructure.adapter.out.entity.Reading;
...
public class Book {
    ...
    @Column(name = "about", nullable = false, length = 64)
    ...
    @Column(name = "read_global_time", nullable = true)
