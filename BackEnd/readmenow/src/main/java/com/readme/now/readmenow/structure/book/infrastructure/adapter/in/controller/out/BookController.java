package com.readme.now.readmenow.structure.book.infrastructure.adapter.in.controller.out;

import com.readme.now.readmenow.structure.book.application.in.ManagingBooks;
import com.readme.now.readmenow.structure.book.infrastructure.adapter.in.controller.in.ContractBook;
...
@RestController
@RequestMapping("/readmenow/api/v2/books")
@AllArgsConstructor
